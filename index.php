...
<!--        <script src='assets/bootstrap/js/bootstrap.bundle.min.js'></script>-->
        ...
        <meta property="og:title" content="Boekdiva Uitgewers" />
        <meta property="og:description" content="Die nuutste publikasies van Boekdiva Uitgewers, 'n uitgewery vir kontemporêre Afrikaanse skryfwerk, is op hierdie blad te sien." />
        <meta property='fb:app_id' content='701264160060226'/>
		<meta property='og:url' content='https://boekdiva.co.za'/>
		<meta property='og:type' content='book' />
        <meta property="og:image" content="https://boekdiva.co.za/assets/images/logo_icon_w.jpg" />
    </head>
        <!-- Google tag (gtag.js) -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7 text-start">
                    <span class="fw-bold fs-4"><i>Heimwee</i></span> is die storie van Mart-Mari wat moet terugkeer na die familieplaas sodat sy haar ma kan
                    begrawe en finaal kan afskeid neem van die familie by wie sy nooit tuis gevoel het nie. Maar in ŉ ondeurdagte oomblik betaal sy die
                    knutselaar-nutsman-van-langsaan, Anton Nieuwoudt, om saam te gaan omdat sy vir haar susters gelieg het oor ŉ man in haar lewe.
                    ...
                    voor haar ophou sodat sy bewus kan word van haar aandeel in haar gekompliseerde familieverhoudinge.<br><br>Dit is ook die storie van
                    ...
                    voorgee sy is getroud, maar dan op ŉ dag in Humansburg se hoofstraat opkyk in die helder heuning van Gert Niemand se oë en besef
                    haar leuen het haar ingehaal.<br><br>Dis ŉ storie wat strek oor geslagte, van mense wat so seer gekry het dat hulle swerf, maar
...
<!--                    <div class="mbr-section-btn pt-3"><a href="https://www.graffitibooks.co.za/af/386821/Boeke" target="_blank" class="btn btn-primary display-4">Koop nou</a></div>-->
            ...
            <div class="row border-top mt-2 pb-2 pt-2 ps-5">
                <div class="col-12 col-md-4 mbr-text mbr-fonts-style display-7 text-left">
                    <b>ISBN</b>: 9780639704494
                </div>
                <div class="col-12 col-md-4 mbr-text mbr-fonts-style display-7 text-left">
                    <b>Prys</b>: R350
                </div>
                <div class="col-12 col-md-4 mbr-text mbr-fonts-style display-7 text-left">
                    <b>Publikasie datum</b>: Oktober 2022
                </div>
<!--            </div>-->
<!--            <div class="row border-top border-bottom border-top mt-2 pb-2 pt-2 ps-5">-->
                <div class="col-12 col-md-4 mbr-text mbr-fonts-style display-7 text-left">
                ...
                <div class="col-12 col-md-4 mbr-text mbr-fonts-style display-7 text-left">
                    <b>Formaat</b>: Sagteband 198 x 129mm
                </div>
                <div class="col-12 col-md-4 mbr-text mbr-fonts-style display-7 text-left">
                    <b>Bladsye</b>: 520
                </div>
            ...
            <div class="row ps-5 border-top">
                <div class="col-12">
                    <div class="mbr-section-btn pt-3">
                        <a href="https://www.graffitibooks.co.za/af/386821/Boeke" target="_blank" class="btn btn-primary display-4">Koop nou - Graffiti Boeke</a>
